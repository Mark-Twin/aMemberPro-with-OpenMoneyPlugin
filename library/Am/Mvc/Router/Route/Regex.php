 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Am_Mvc_Router_Route_Regex extends Am_Mvc_Router_Route_Abstract
{
    ...
    public function assemble($data = array(), $reset = false, $encode = false, $partial = false)
    {
        if ($this->_reverse === null) {
            ...
            throw new Am_Mvc_Router_Exception('Cannot assemble. Reversed route is not specified.');
        }
        ...
        if ($return === false) {
            //--//require_once 'Zend/Controller/Router/Exception.php';
            throw new Am_Mvc_Router_Exception('Cannot assemble. Too few arguments?');
        }
